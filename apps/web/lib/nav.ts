...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/experiences", label: "Interview Experiences", icon: "chat", keywords: "interview experience writeup rounds offer rejected company debrief" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/orgs", label: "Organizations", icon: "building", keywords: "org company enterprise team console work onboarding training employer" },
