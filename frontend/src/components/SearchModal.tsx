...
const ALL_ITEMS: SearchResult[] = [
  ...
  { title: 'Skill Assessments',     subtitle: 'Test your JS, Python, SQL, React, OS, System Design — earn grade badges and XP', icon: 'fact_check', path: '/app/assessments', color: 'text-emerald-400' },
