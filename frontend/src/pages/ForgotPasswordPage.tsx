  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 16px' }}>
      ...
      <div style={{ width: '100%', maxWidth: 440, position: 'relative', zIndex: 1 }}>
        <Link to="/login" style={{ display: 'flex', alignItems: 'center', gap: 8, color: 'var(--t3)', fontSize: 14, textDecoration: 'none', marginBottom: 32 }}>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} style={{ ...GLASS, borderRadius: 20, padding: 40 }}>
          <div style={{ marginBottom: 32 }}>
            ...
            <h1 style={{ fontSize: 24, fontWeight: 900, letterSpacing: '-0.03em', marginTop: 16, marginBottom: 8, color: 'var(--t1)' }}>Forgot password?</h1>
            <p style={{ color: 'var(--t3)', fontSize: 14 }}>Enter your email and we'll send a reset link.</p>
          </div>
          ...
          {sent ? (
            <div style={{ textAlign: 'center', padding: '24px 0' }}>
              ...
              <p style={{ fontWeight: 700, color: 'var(--t1)', marginBottom: 8 }}>Check your inbox</p>
              <p style={{ color: 'var(--t3)', fontSize: 14 }}>If an account exists for <span style={{ color: '#d4d4d8' }}>{email}</span>, you'll receive a reset link shortly.</p>
            </div>
          ) : (
            <form onSubmit={submit} className="space-y-5">
              <div>
                <label htmlFor="fp-email" style={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: 'var(--t3)', display: 'block', marginBottom: 8 }}>Email</label>
                <input
                  id="fp-email"
                  type="email"
                  required
                  ...
                  style={{ width: '100%', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, padding: '14px 20px', color: 'var(--t1)', fontSize: 14, outline: 'none', boxSizing: 'border-box' }}
