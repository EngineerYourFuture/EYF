...
function TopicContentCards({ content }: Readonly<{ content: TopicContent | null }>) {
  if (content === null) {
    return (
      <>
  ...
  return (
    <>
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.06 }} style={{ ...GLASS, borderRadius: 16, padding: 32 }}>
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12 }} style={{ ...GLASS, borderRadius: 16, padding: 32 }}>
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.18 }} style={{ ...GLASS, borderRadius: 16, overflow: 'hidden' }}>
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.24 }} style={{ background: 'rgba(232,33,39,0.06)', border: '1px solid rgba(232,33,39,0.2)', borderRadius: 16, padding: 32 }}>
    ...
    <AppShell>
      <div style={{ paddingTop: 32, maxWidth: 768, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          <TopicContentCards content={content} />
        </div>
